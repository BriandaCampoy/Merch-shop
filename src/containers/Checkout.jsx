          ...
          <div className="Checkout-item" key={item.product.title}>
            <div className="Checkout-element">
              ...
              <div className="Checkout-element-cant">
                <button className="Checkout-element-remove" onClick={()=>handleChangeCant(item, -1)}>-</button>
                <span>{item.cant}</span>
                <button className="Checkout-element-add" onClick={()=>handleChangeCant(item, 1)}>+</button>
              </div>
              <span className='Checkout-element-productTotal'>${(item.product.price)*(item.cant)}</span>
            </div>
